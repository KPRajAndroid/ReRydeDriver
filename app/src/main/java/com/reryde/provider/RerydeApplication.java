...
import com.reryde.provider.Utilities.FontsOverride;
...
public class RerydeApplication extends Application {

    public static final String TAG = RerydeApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static RerydeApplication mInstance;

    public static byte[] Prof_bitmap;
    public static byte[] veh_bitmap;
    public static byte[] lic_bitmap;


    public static ImageView profile_pic;
    public static ImageView veh_pic;
    public static ImageView lic_pic;


    public static String profile_pic_path;
    public static String veh_pic_path;
    public static String lic_pic_path;



    public static List<CityListModel> WORLD_COUNTRIES = new ArrayList<>();
...
//        FontsOverride.setDefaultFont(this, "SANS_SERIF", "ClanPro-Book.otf");
        HyperTrack.initialize(this, "pk_test_dd3d88f9ff05e73c1c077a6bdb6dfd56babfff2a");
    }
    ...
    public static synchronized RerydeApplication getInstance() {
        return mInstance;
    }
