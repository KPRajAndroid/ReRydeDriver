...
import com.reryde.provider.Utilities.MyButton;
...
//            login(accessToken, URLHelper.GOOGLE_LOGIN, "google");
    ...
    private void loadTermsView(final String loginBy)
    {
        try
        {
            final AlertDialog.Builder termsViewBuilder = new AlertDialog.Builder(ActivitySocialLogin.this);
            View loadView = getLayoutInflater().inflate(R.layout.terms_view_layout, null);
