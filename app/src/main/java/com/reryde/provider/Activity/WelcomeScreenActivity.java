...
import com.reryde.provider.Fragment.WelcomeScreen1;
import com.reryde.provider.Fragment.WelcomeScreen2;
import com.reryde.provider.Fragment.WelcomeScreen3;
...
//                finish();
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WelcomeScreenActivity.this, ActivityEmail.class).putExtra("signup", true).putExtra("viewpager", "yes").addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                overridePendingTransition(R.anim.slide_in_right, R.anim.anim_nothing);
//                finish();
            }
        });
