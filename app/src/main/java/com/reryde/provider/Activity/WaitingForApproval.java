    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent = new Intent(WaitingForApproval.this, LoginActivity.class);
        ...
        TextView uploadDocTxt = (TextView) findViewById(R.id.upload_doc_txt);

        uploadDocTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WaitingForApproval.this, DocumentActivity.class));
            }
        });
