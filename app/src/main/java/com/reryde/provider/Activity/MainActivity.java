...
import com.reryde.provider.Bean.Connect;
import com.reryde.provider.Fragment.EarningsFragment;
import com.reryde.provider.Fragment.Help;
import com.reryde.provider.Fragment.Map;
...
import com.reryde.provider.Listeners.ConnectionBooleanChangedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static TextView txtName, approvaltxt;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_refer:
                        drawer.closeDrawers();
                        startActivity(new Intent(MainActivity.this, FreeRides.class));
                        ff = true;
                        break;
                    ...
                    case R.id.driver_wallet:
                        drawer.closeDrawers();
                        startActivity(new Intent(MainActivity.this, WalletActiivity.class));
                        break;
...
//                        GoToFragment();
    ...
    public static void loadNavHeader() {
        // name, website
        ...
        if (SharedHelper.getKey(context, "approval_status").equals("new") || SharedHelper.getKey(context, "approval_status").equals("onboarding")) {
            ...
            approvaltxt.setText(context.getText(R.string.waiting_for_approval));
            ...
            approvaltxt.setText(context.getText(R.string.banned));
            status.setImageResource(R.drawable.banned);
        } else {
            approvaltxt.setTextColor(Color.GREEN);
            approvaltxt.setText(context.getText(R.string.approved));
...
//                }
    ...
    public void navigateToShareScreen(String shareUrl) {
        ...
        String shareMessage = "Hi, I’m driving with ReRyde to earn more money. Download ReRyde Driver and start earning more money too! ";
