package com.reryde.provider.Services;
...
import com.reryde.provider.FloatingViewService.FloatingViewListener;
import com.reryde.provider.FloatingViewService.FloatingViewManager;
...
public class CustomFloatingViewService extends Service implements FloatingViewListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ImageView iconView = (ImageView) mFloatingView.findViewById(R.id.collapsed_iv);
        ImageView close_btn = (ImageView) mFloatingView.findViewById(R.id.close_btn);

        mFloatingView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // メールアプリの起動
                Intent intent = new Intent(CustomFloatingViewService.this, MainActivity.class);
